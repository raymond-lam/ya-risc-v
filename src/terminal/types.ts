...
/**
 * Host arguments to start the terminal worker. Node streams are converted to
 * transferable Web streams before handoff.
 */
...
export type { TerminalRunOptions, TerminalWorkerData };
